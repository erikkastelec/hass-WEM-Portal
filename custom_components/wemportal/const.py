...
ENERGY_KEYWORDS: Final = ["energie", "energy", "wärmemenge", "warmemenge"]
POWER_KEYWORDS: Final = ["leistung", "power"]
FREQUENCY_KEYWORDS: Final = ["frequenz", "frequency", "drehzahl"]
DURATION_KEYWORDS: Final = ["stunden", "hours", "laufzeit", "betriebsstunden"]
PRESSURE_KEYWORDS: Final = ["druck", "pressure"]
VOLUME_FLOW_KEYWORDS: Final = ["volumenstrom", "flow"]
